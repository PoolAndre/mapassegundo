...
public class Moderna7Maps extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng piedra = new LatLng(-22.951728275116, -43.21046574536);
        mMap.addMarker(new MarkerOptions().position(piedra).title("La estatua del Cristo Redentor").snippet("La estatua, de 38 metros de altura, está situada en el cerro del Corcovado ")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.jesus)));

        //mostrar toast con el marcador
        LatLng totus = new LatLng(-22.951728275116, -43.21046574536);
        mMap.addMarker(new MarkerOptions().position(totus).draggable(true).title("La estatua del Cristo Redentor").snippet("La estatua, de 38 metros de altura, está situada en el cerro del Corcovado")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.jesus)));
        //zoom al amrcador
