...
public class Antigua6Maps extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng piedra = new LatLng(36.451789527493, 28.225846265807);
        mMap.addMarker(new MarkerOptions().position(piedra).title(" El Coloso de Rodas").snippet("Una enorme estatua del dios Helios, que se encontraba en la localidad de Rodas, Grecia. Fue construido en el año 292 a.C. ")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.coloso)));

        //mostrar toast con el marcador
        LatLng totus = new LatLng(36.451789527493, 28.225846265807);
        mMap.addMarker(new MarkerOptions().position(totus).draggable(true).title(" El Coloso de Rodas").snippet("Una enorme estatua del dios Helios, que se encontraba en la localidad de Rodas, Grecia. Fue construido en el año 292 a.C.")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.coloso)));
        //zoom al amrcador
