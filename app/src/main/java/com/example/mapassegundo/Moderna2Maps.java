...
public class Moderna2Maps extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng petra = new LatLng(30.323070631, 35.4803225039);
        mMap.addMarker(new MarkerOptions().position(petra).title("Petra").snippet("Una de las joyas de Jordania, fundada en el siglo VIII a.C. ")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.petra)));

        //mostrar toast con el marcador
        LatLng totus = new LatLng(30.323070631, 35.4803225039);
        mMap.addMarker(new MarkerOptions().position(totus).draggable(true).title("Petra").snippet(" Una de las joyas de Jordania, fundada en el siglo VIII a.C.")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.petra)));
        //zoom al amrcador
