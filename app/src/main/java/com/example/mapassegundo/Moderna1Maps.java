...
public class Moderna1Maps extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng piedra = new LatLng(27.1750151, -71.976312);
        mMap.addMarker(new MarkerOptions().position(piedra).title("Taj Majal").snippet("Lo puedes encontrar en la ciudad de Agra, en la India")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.tajmahal)));

        //mostrar toast con el marcador
        LatLng totus = new LatLng(27.1750151, 78.0421552);
        mMap.addMarker(new MarkerOptions().position(totus).draggable(true).title("Taj Majal").snippet(" Lo puedes encontrar en la ciudad de Agra, en la India.")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.tajmahal)));
        //zoom al amrcador
