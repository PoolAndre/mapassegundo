...
public class Moderna5Maps extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng piedra = new LatLng(-13.162942698749, -72.54496290320);
        mMap.addMarker(new MarkerOptions().position(piedra).title("Machu Picchu").snippet("Está ubicado en Perú, a menos de 100 km de Cuzco, y se cree que se construyó antes del siglo XV.  ")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.machupicchu)));

        //mostrar toast con el marcador
        LatLng totus = new LatLng(-13.162942698749, -72.54496290320);
        mMap.addMarker(new MarkerOptions().position(totus).draggable(true).title("Machu Picchu").snippet(" Está ubicado en Perú, a menos de 100 km de Cuzco, y se cree que se construyó antes del siglo XV. ")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.machupicchu)));
        //zoom al amrcador
